...
export class Contract extends ethereum.SmartContract {
  ...
  getTokensCID(_cid: string): Array<BigInt> {
    let result = super.call(
      "getTokensCID",
      "getTokensCID(string):(uint256[])",
  ...
  try_getTokensCID(_cid: string): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "getTokensCID",
      "getTokensCID(string):(uint256[])",
      [ethereum.Value.fromString(_cid)]
...
export class AddCidCall extends ethereum.Call {
  get inputs(): AddCidCall__Inputs {
    return new AddCidCall__Inputs(this);
  }

  get outputs(): AddCidCall__Outputs {
    return new AddCidCall__Outputs(this);
  }
}

export class AddCidCall__Inputs {
  _call: AddCidCall;

  constructor(call: AddCidCall) {
    this._call = call;
  }
...
export class AddCidCall__Outputs {
  _call: AddCidCall;
